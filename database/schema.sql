-- Evantis Home Database Schema

CREATE DATABASE IF NOT EXISTS evantis_home CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE evantis_home;
...
-- Import Logs Table (JSON import tracking)
